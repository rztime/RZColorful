...
//    }];
    ...
    NSString *url = @"http://pic4.nipic.com/20091217/3885730_124701000519_2.jpg";
    [textView rz_colorfulConferInsetTo:rzConferInsertPositionDefault append:^(RZColorfulConferrer * _Nonnull confer) {
        confer.text(@"hello，大家好\n").font(FONT(21));
        confer.appendImage([UIImage imageNamed:@"flower"]);
        confer.text(@"设置颜色加字体\n").textColor(RGB(255, 255 ,80)).font(FONT(25));
        confer.text(@"颜色加字体,以及字体所在加个背景\n").textColor(RGB(255, 55 ,80)).font(FONT(25)).backgroundColor(RGB(230, 230, 230));
        ...
        // 通过图片url加载图片
        confer.appendImageByUrl(url).bounds(CGRectMake(0, 0, 0, 100)); //
...
- (void)dealloc {
    NSLog(@"__%s__ dealloc", __FUNCTION__);
}
