#
#  Be sure to run `pod spec lint RZColorful.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                      在 NSAttributedString中新增tapAction，点击事件，但需实现UITextView的rzDidTapTextView方法，通过返回的tapAction的tapId或NSURL区分点击结果
                   DESC
  ...
  s.source       = { :git => "https://github.com/rztime/RZColorful.git", :tag => "#{s.version}" }
